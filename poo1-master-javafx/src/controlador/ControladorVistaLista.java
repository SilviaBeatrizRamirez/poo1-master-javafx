...
public class ControladorVistaLista implements Initializable {
    ...
    void clicCambiar(ActionEvent event) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/vistas/VistaCombo.fxml"));     
        Parent root = (Parent)fxmlLoader.load();
        ControladorVistaCombo controlador = fxmlLoader.<ControladorVistaCombo>getController();
