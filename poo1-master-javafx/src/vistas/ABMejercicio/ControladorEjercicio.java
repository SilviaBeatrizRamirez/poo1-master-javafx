...
public class ControladorEjercicio implements Initializable {
    ...
    void clicCambiar(ActionEvent event) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/controladorEjercicio/VistaCombo.fxml"));     
